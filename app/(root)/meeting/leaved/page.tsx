...
export const metadata: Metadata = {
	title: "Nexus - Leaved",
	description: "You Leaved the Meeting.",
};
...
export default function Component() {
	return (
		<div className='flex flex-col items-center justify-center h-screen  text-gray-50 '>
			<div className='max-w-md  px-10 py-8 rounded-lg bg-dark-1 shadow-lg z-50 border border-slate-700'>
				<div className='flex flex-col items-center justify-center'>
					<i className='fas fa-phone-slash text-6xl text-gray-200'></i>
